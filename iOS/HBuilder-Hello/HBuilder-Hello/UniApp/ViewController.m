...
//    PDRCore *coreInstance = [PDRCore Instance];
//    PDRCoreApp *app = (PDRCoreApp *)coreInstance.appManager.activeApp;
//    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(10 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
//
//        [app.mainFrame evaluateJavaScript:@"console.log('this is call from native')" completionHandler:nil];
//        [app.mainFrame evaluateJavaScript:@"doSomeTest()" completionHandler:nil];
//
//    });
}
