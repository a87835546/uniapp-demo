...
Z([3,'content'])
Z([3,'item_content'])
Z([3,'item_content_title'])
Z([a,[[7],[3,'title']]])
Z([3,'item_content_desc'])
Z([3,'description'])
Z([3,'item_content_image'])
Z([3,'center'])
Z([3,'/static/logo.png'])
...
var x=['./node-modules/@dcloudio/uni-ui/lib/uni-badge/uni-badge.wxml','./node-modules/@dcloudio/uni-ui/lib/uni-collapse-item/uni-collapse-item.wxml','./node-modules/@dcloudio/uni-ui/lib/uni-collapse/uni-collapse.wxml','./node-modules/@dcloudio/uni-ui/lib/uni-icon/uni-icon.wxml','./node-modules/@dcloudio/uni-ui/lib/uni-list-item/uni-list-item.wxml','./node-modules/@dcloudio/uni-ui/lib/uni-list/uni-list.wxml','./pages/index/collapse-item.wxml','./pages/index/home-item.wxml','./pages/index/index.wxml','./pages/index/test.wxml','./pages/mine/message/msg.wxml','./pages/mine/mine.wxml'];d_[x[0]]={}
...
var oVB=_mz(z,'view',['bindtap',5,'class',1,'data-event-opts',2],[],tSB,aRB,gg)
var xWB=_n('view')
_rz(z,xWB,'class',8,tSB,aRB,gg)
var oXB=_mz(z,'uni-icon',['bind:__l',9,'class',1,'size',2,'type',3,'vueId',4],[],tSB,aRB,gg)
_(xWB,oXB)
var fYB=_n('text')
_rz(z,fYB,'class',14,tSB,aRB,gg)
var cZB=_oz(z,15,tSB,aRB,gg)
_(fYB,cZB)
_(xWB,fYB)
var h1B=_mz(z,'uni-icon',['bind:__l',16,'class',1,'size',2,'type',3,'vueId',4],[],tSB,aRB,gg)
_(xWB,h1B)
_(oVB,xWB)
var o2B=_n('view')
_rz(z,o2B,'class',21,tSB,aRB,gg)
_(oVB,o2B)
_(eTB,oVB)
return eTB
}
...
_(e8B,b9B)
_(l5B,e8B)
var o0B=_mz(z,'image',['class',6,'mode',1,'src',2],[],e,s,gg)
_(l5B,o0B)
_(o4B,l5B)
_(r,o4B)
return r
...
var fCC=_mz(z,'uni-badge',['type',-1,'bind:__l',1,'text',1,'vueId',2],[],e,s,gg)
_(oBC,fCC)
...
_(cDC,hEC)
_(oBC,cDC)
var cGC=_mz(z,'uni-collapse',['bind:__l',9,'bind:change',1,'class',2,'data-event-opts',3,'vueId',4,'vueSlots',5],[],e,s,gg)
var oHC=_mz(z,'uni-collapse-item',['bind:__l',15,'title',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var lIC=_mz(z,'uni-list',['bind:__l',19,'vueId',1,'vueSlots',2],[],e,s,gg)
var aJC=_mz(z,'uni-list-item',['bind:__l',22,'note',1,'showExtraIcon',2,'title',3,'vueId',4,'vueSlots',5],[],e,s,gg)
var tKC=_oz(z,28,e,s,gg)
_(aJC,tKC)
_(lIC,aJC)
var eLC=_mz(z,'uni-list-item',['badgeText',29,'bind:__l',1,'note',2,'showBadge',3,'title',4,'vueId',5,'vueSlots',6],[],e,s,gg)
var bMC=_oz(z,36,e,s,gg)
_(eLC,bMC)
_(lIC,eLC)
var oNC=_mz(z,'uni-list-item',['bind:__l',37,'title',1,'vueId',2],[],e,s,gg)
_(lIC,oNC)
_(oHC,lIC)
_(cGC,oHC)
var xOC=_mz(z,'uni-collapse-item',['bind:__l',40,'open',1,'title',2,'vueId',3,'vueSlots',4],[],e,s,gg)
var oPC=_n('view')
...
_(xOC,oPC)
var cRC=_n('view')
_rz(z,cRC,'style',47,e,s,gg)
var hSC=_oz(z,48,e,s,gg)
_(cRC,hSC)
_(xOC,cRC)
_(cGC,xOC)
var oTC=_mz(z,'uni-collapse-item',['bind:__l',49,'disabled',1,'title',2,'vueId',3,'vueSlots',4],[],e,s,gg)
var cUC=_n('view')
_rz(z,cUC,'style',54,e,s,gg)
var oVC=_oz(z,55,e,s,gg)
_(cUC,oVC)
_(oTC,cUC)
_(cGC,oTC)
var lWC=_mz(z,'uni-collapse-item',['bind:__l',56,'title',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var aXC=_mz(z,'collapse-item',['bind:__l',60,'bind:collapseItemClick',1,'data-event-opts',2,'obj',3,'vueId',4],[],e,s,gg)
_(lWC,aXC)
_(cGC,lWC)
_(oBC,cGC)
var tYC=_v()
...
var f5C=_mz(z,'view',['bindtap',69,'class',1,'data-event-opts',2],[],o2C,b1C,gg)
var c6C=_mz(z,'item',['bind:__l',72,'class',1,'title',2,'vueId',3],[],o2C,b1C,gg)
_(f5C,c6C)
_(x3C,f5C)
return x3C
}
tYC.wxXCkey=4
_2z(z,67,eZC,e,s,gg,tYC,'newitem','index','index')
var h7C=_n('view')
_rz(z,h7C,'class',76,e,s,gg)
var o8C=_mz(z,'test',['bind:__l',77,'vueId',1],[],e,s,gg)
_(h7C,o8C)
_(oBC,h7C)
_(r,oBC)
return r
...
var lAD=_mz(z,'input',['class',1,'data-ref',1,'placeholder',2,'type',3,'value',4],[],e,s,gg)
_(o0C,lAD)
_(r,o0C)
return r
}
...
_(tCD,eDD)
var bED=_mz(z,'button',['bindtap',2,'data-event-opts',1,'type',2],[],e,s,gg)
...
var lOD=_n('view')
_rz(z,lOD,'class',5,oLD,hKD,gg)
var aPD=_mz(z,'view',['bindtap',6,'class',1,'data-event-opts',2],[],oLD,hKD,gg)
var tQD=_mz(z,'image',['class',9,'mode',1,'src',2],[],oLD,hKD,gg)
_(aPD,tQD)
var eRD=_n('text')
_rz(z,eRD,'class',12,oLD,hKD,gg)
var bSD=_oz(z,13,oLD,hKD,gg)
_(eRD,bSD)
_(aPD,eRD)
var oTD=_mz(z,'image',['class',14,'mode',1,'src',2],[],oLD,hKD,gg)
_(aPD,oTD)
_(lOD,aPD)
_(cMD,lOD)
return cMD
...
__wxAppCode__['pages/index/collapse-item.wxss']=setCssToHead([".",[1],"content { color: red; }\n.",[1],"item { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; height: ",[0,80],"; line-height: ",[0,80],"; width: 100vw; font-size: 12px; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"item_contair { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; }\n.",[1],"item_icon { -webkit-box-flex: 0 ; -webkit-flex: 0 ; -ms-flex: 0 ; flex: 0 ; padding-left: 10px; width: ",[0,30],"; }\n.",[1],"item_content { -webkit-box-flex: 1; -webkit-flex: 1; -ms-flex: 1; flex: 1; padding-left: 10px; -webkit-box-sizing: border-box; box-sizing: border-box; font-size: 12; }\n.",[1],"item_icon_right{ -webkit-box-flex: 0; -webkit-flex: 0; -ms-flex: 0; flex: 0; padding-right: 10px; width: ",[0,30],"; }\n.",[1],"item_row { -webkit-box-flex: 0; -webkit-flex: 0 0 auto; -ms-flex: 0 0 auto; flex: 0 0 auto; height: ",[0,1],"; background-color: #4CD964; width: 100vw - ",[0,10],"; margin: 0 ",[0,10],"; }\n",],undefined,{path:"./pages/index/collapse-item.wxss"});    
__wxAppCode__['pages/index/collapse-item.wxml']=$gwx('./pages/index/collapse-item.wxml');

__wxAppCode__['pages/index/home-item.wxss']=setCssToHead([".",[1],"content { width: 100vw; }\n.",[1],"item_content { -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; width: 100vw; padding: 0 ",[0,10]," 0 ",[0,10],"; -webkit-box-sizing: border-box; box-sizing: border-box; -webkit-box-pack: start; -webkit-justify-content: flex-start; -ms-flex-pack: start; justify-content: flex-start; overflow: hidden; }\n.",[1],"item_content_title { }\n.",[1],"item_content_desc { }\n.",[1],"item_content_image { width: 30px; height: 30px; }\n",],undefined,{path:"./pages/index/home-item.wxss"});    
__wxAppCode__['pages/index/home-item.wxml']=$gwx('./pages/index/home-item.wxml');

__wxAppCode__['pages/index/index.wxss']=setCssToHead([".",[1],"content { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; }\n.",[1],"logo { height: ",[0,200],"; width: ",[0,200],"; margin-top: ",[0,200],"; margin-left: auto; margin-right: auto; margin-bottom: ",[0,50],"; }\n.",[1],"text-area { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; }\n.",[1],"title { font-size: ",[0,36],"; color: #8f8f94; }\n.",[1],"content_item { width: 100vw; }\n.",[1],"home { border-bottom: ",[0,1]," solid #C0C0C0; }\n.",[1],"collapse { width: 100vw; }\nwx-uni-collapse-item { height: 100%; width: 100vw; }\n",],undefined,{path:"./pages/index/index.wxss"});    
